        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 max-w-xs">
              Build production-ready websites from a single prompt with AI-powered code generation using Claude SDK.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a
                href="https://github.com/nitinverma78"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://twitter.com/nitinverma78"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://linkedin.com/in/nitinverma78"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
