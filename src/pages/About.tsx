  ...
  const features = [
    {
      ...
      description:
        "Leveraging Claude SDK and Anthropic's advanced AI models to generate production-ready code from natural language descriptions.",
    },
    {
      icon: Code,
      title: "Modern Tech Stack",
      description:
        "Built with Next.js 14, TypeScript, and the latest web technologies for optimal performance and developer experience.",
    },
    {
      icon: Zap,
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">About Xuro</h1>
            ...
            <div className="relative">
              <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800/30 rounded-2xl p-8 hover:border-gray-700/50 transition-all duration-500">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-4">
                  Xuro was created to democratize web development by making it accessible to everyone, regardless of
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Powered by Claude SDK and Anthropic's advanced AI models, Xuro represents the next generation of
            ...
            <div className="relative">
              <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800/30 rounded-2xl p-8 md:p-12 hover:border-gray-700/50 transition-all duration-700">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-white mb-4">What Makes Xuro Different</h2>
                </div>
                <div className="grid md:grid-cols-2 gap-6 text-gray-300">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <p>
                        <strong className="text-white">Claude SDK Integration:</strong> Unlike other platforms, we use
                        Anthropic's Claude SDK for superior code generation, understanding context and nuance in your
                        requirements.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0" />
                      <p>
                        <strong className="text-white">Modern Architecture:</strong> Built with Next.js 14, TypeScript,
            ...
            <div className="relative">
              <div className="bg-gray-900/20 border border-gray-800/30 backdrop-blur-sm rounded-2xl p-8 hover:bg-gray-900/60 hover:border-gray-700/50 transition-all duration-500">
                ...
                <p className="text-gray-300 text-center max-w-2xl mx-auto">
                  We leverage cutting-edge technologies including Claude SDK for AI-powered code generation, ensuring
                  your websites are fast, modern, and built with industry best practices. Our platform combines the
                  power of Anthropic's AI with proven web development frameworks to deliver exceptional results.
                </p>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 md:p-12 hover:border-gray-700/50 transition-all duration-700">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed mb-4 max-w-3xl mx-auto">
                    Xuro represents a paradigm shift in how we approach web development. By combining the creativity and
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed mb-6 max-w-3xl mx-auto">
                    ...
                    a great idea, Xuro empowers you to create professional, scalable web applications with unprecedented
                    ease and speed.
                  </p>
