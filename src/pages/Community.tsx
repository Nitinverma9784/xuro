        ...
        <div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Discover and share pre-built components created by the Xuro community
            </p>
          </div>
              ...
              <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 bg-gray-800/50">
                {categories.map((category) => (
                  <TabsTrigger
                    key={category.id}
                    value={category.id}
                    className="flex items-center gap-2 text-xs md:text-sm data-[state=active]:bg-blue-600"
                  >
