        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Have questions about Xuro? Want to collaborate? We'd love to hear from you.
            </p>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:nitin@xuro.dev" className="text-blue-400 hover:text-blue-300 transition-colors">
                          nitin@xuro.dev
                        </a>
                      </div>
                    </div>
            ...
            <Card className="bg-gray-900/30 border-gray-700/30 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-medium text-white mb-2">How does Xuro work?</h4>
                      <p className="text-gray-300 text-sm">
                        Simply describe your website in natural language, and our AI powered by Claude SDK will generate
