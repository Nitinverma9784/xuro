  ...
  const handleEnhancePrompt = async () => {
    ...
    setTimeout(() => {
      const enhancedPrompts = [
        `${prompt} with modern responsive design, dark mode support, and smooth animations`,
        `${prompt} featuring clean UI/UX, mobile-first approach, and accessibility features`,
        `${prompt} with advanced functionality, user authentication, and database integration`,
        `${prompt} including SEO optimization, performance enhancements, and modern styling`,
        `${prompt} with interactive components, real-time features, and professional layout`,
      ]
      ...
      toast.success("Prompt enhanced!", {
        description: "Your prompt has been improved with additional details and features.",
      })
    }, 2000)
  }
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <div className="relative">
              <Textarea
                ...
                placeholder="How can Xuro help you today?"
              ...
              <div className="absolute bottom-4 right-4">
                <Button size="icon" variant="ghost" className="text-gray-500 hover:text-blue-400 hover:bg-gray-800/50">
