        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              The journey behind Xuro and the people who made it possible
            </p>
          </div>
            ...
            <Card className="bg-gray-900/20 border-gray-700/20 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  me to modern technologies like Claude SDK and showed me how AI can enhance development workflows. His
            ...
            <Card className="bg-gray-900/20 border-gray-700/20 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  intersection of AI and web development. I dove deep into Claude SDK, experimented with different AI
                  models, and learned how to integrate them seamlessly into modern web applications. This exploration
                  led to the creation of Xuro—a platform that combines the power of AI with intuitive design to make web
